...
/* config */
#define CONFIG_XENO_BUILD_ARGS " '--with-core=cobalt' '--enable-smp' '--enable-pshared'"
...
/* config */
#define CONFIG_XENO_REVISION_LEVEL 9
...
/* config */
#define CONFIG_XENO_VERSION_STRING "3.0.9"
...
#define PACKAGE_STRING "Xenomai 3.0.9"
