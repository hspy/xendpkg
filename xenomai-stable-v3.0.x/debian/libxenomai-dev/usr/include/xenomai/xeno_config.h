...
/* config */
#define CONFIG_XENO_BUILD_ARGS " '--prefix=/usr' '--includedir=/usr/include/xenomai' '--mandir=/usr/share/man' '--with-testdir=/usr/lib/xenomai/testsuite' '--with-core=cobalt' '--enable-smp' '--enable-pshared' '--build' 'x86_64-linux-gnu' 'build_alias=x86_64-linux-gnu'"
